...
<head>
    ...
    <style>
        ...
        .st-meta-item { text-align: center; }
        ...
        .st-btn-outline:hover { background: #fff5ee; }
        ...
        .st-btn-solid:hover { opacity: 0.9; }
        ...
        .st-error .icon { font-size: 56px; margin-bottom: 12px; }
        ...
        @media print {
            ...
            .st-card { box-shadow: none; border: 1px solid #ddd; }
        }
...
<div class="st-wrap">
    ...
    <?php if ($transaction): ?>
        ...
        <!-- Sukses Banner -->
        <div class="st-sukses no-print">
            <div class="st-sukses-icon">✅</div>
